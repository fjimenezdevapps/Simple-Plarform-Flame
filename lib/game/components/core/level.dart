...
import 'package:platform_game/game/components/utils/background_tile.dart';
...
class Level extends World with HasGameRef<SimplePlatformer> {
        ...
        switch (spawnPoint.class_) {
          ...
          case 'FallingPlatform':
            final fallingPlatform = FallingPlatform(
                collisionPlatform: CollisionBlock(
                  position: Vector2(spawnPoint.x, spawnPoint.y),
                  size: Vector2(spawnPoint.width, spawnPoint.height),
                  isPlatform: true,
                ),
